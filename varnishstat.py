#!/usr/bin/env python
"""
Rackspace Cloud Monitoring plugin to provide varnishd statistics.

Copyright 2015 Joe Ashcraft <joe.ashcraft@rackspace.com>
...
def varnishd_stats(host, port):
    regex = re.compile(ur"(.*) ([0-9]*) ([0-9.]*) (.*)\r")
    try:
